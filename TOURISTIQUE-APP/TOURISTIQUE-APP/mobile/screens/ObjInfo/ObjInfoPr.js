...
import { FlatList, TouchableOpacity, Image, View, StyleSheet, Text, Button, SafeAreaView } from 'react-native';
...
const Card_Width = sizes.width - 20; // Adjusted the Card_Width
const Card_Height = 250; // Adjusted the Card_Height
              ...
              <View style={styles.cardContainer}>
                ...
                <View style={styles.infoContainer}>
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.9}
                    onPress={() => addF(item)} // Pass the item to addF
                  >
