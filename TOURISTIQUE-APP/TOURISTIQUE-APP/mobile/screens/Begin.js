    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={{textAlign: 'center',marginVertical: 10,color: 'white',fontSize: 20,fontWeight: '600',}}>or</Text>
          ...
          <TouchableOpacity style={styles.cardapi} onPress={handleHome} >
            ...
            <Text style={{color: 'white' , fontWeight : 'bold' , fontSize : 16,textAlign:'center' }}>Don't have an account ?  
